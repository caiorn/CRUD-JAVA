...
public class JNumberFormatField extends JTextField {
    ...
    /**
     * Define o limite do campo, limit &< 0 para deixar livre (default) Ignora
     * os pontos e virgulas do formato, conta somente com os números
     *
     * @param limit
     */
    ...
    public static void main(String[] args) {
        ...
        JNumberFormatField j = new JNumberFormatField(new DecimalFormat("#,##0.00")) {
            {
        ...
        frame.add(j);
        //setando valores double
        double d = 2101.50;
        j.setValue(new BigDecimal(d));
        //pegando valores double
        double v = j.getValue().doubleValue();
